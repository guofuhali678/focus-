...
char ssid[]="xty2005";//Pura70
char pass[]="987654321";//12345678
const char broker[]    = "alic4ml6ik0.iot-06z00gw8yhs9yzi.mqtt.iothub.aliyuncs.com";
int        port        = 1883;
const char willTopic[] = "arduino/will";
const char inTopic[]   = "/sys/k28ypDdj6CO/esp8266_dev/thing/service/property/set";
const char outTopic[]  = "/sys/k28ypDdj6CO/esp8266_dev/thing/event/property/post";
...
void setup() {
  ...
  Serial.println();
  mqttClient.setId("esp8266_dev|securemode=2,signmethod=hmacsha256,timestamp=1736922662269|");
  mqttClient.setUsernamePassword("esp8266_dev&k28ypDdj6CO","cd91400a8139f8d337f4f8c4663c3df7d129cc85a485f6d72470704d5059e68c");
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    payload="{\"params\":\"temp\":55,\"humi\":66},\"version\":\"1,0,0\"}";//读取真实的那里要按下面改。
